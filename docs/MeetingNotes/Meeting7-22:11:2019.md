...
* Looking at graph visualisation mechanisms - CanvaJS? Gravity / centralisation physics?

#### Ethics Approval
* Sent information in, with an updated protocol and a list of answers to the chair's questions in an email. Will h
opefully receive confirmation by January :(
...
2. Hopefully have ethics approval by then
