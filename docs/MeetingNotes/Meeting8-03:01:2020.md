...
9. Entities crashing site
    ...
    - Ouranos
        Same with Medousa. Says is part of "the Genitals of Ouranos" which is not a collective. Inconsistency with understanding of use of "is part of". Should keep it consistent with just collectives.
    - Children of Iphicles and Pyrrha
10. Add sibling (sister/brother) reversal for when two agents have the same parents (e.g. X, Y is son of Z, A) - __IS THERE AN EXAMPLE OF THIS I CAN TEST OUT?__
11. Add "is twin of" - &#9745;
