...
- Currently not clear that the different mothers listed are all alternatives
    - Make "OR" for all elements
- Siblings
    - Implicit parents
    ...
    - Greta might consider removing passage references for siblings
- SEE SHEET FOR REST
- Gender on all entity cards now, no parsing from my end
