...
2. Research GEDCOM 
    ...
    * Potentially implement GEDCOM algorithm
...
5. Enrol in COMP4540 semester 1 - ```Permission codes will be given out in early February```
...
8. Hebe not showing up as mother for 8182191 and 8182126 because in parsed relationship data, is listed as "MOTHERS]"
