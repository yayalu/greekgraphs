...
4. Leave the disputed and unusual relationships as is
...
9. Divine father paradigm
    - Ignore this so far, and just put them as contested parentage
    - Mention in thesis that this is ignoreed (might also create a few bugs!)
...
11. Write up a rough main chapter draft to show the team on Thursday
...
14. DON'T grey out the alternate disputed relationship for now.
