          ...
          <div>
            ...
            >
              ...
              >
                ...
                Overview of Project: MANTO (link: manto-myth.org) is an
                ambitious initiative to collect, organize, and visualize the
                data of Greek myth. It is a collaboration between researchers
                and students at the Australian National University, and the
                University of New Hampshire. Our aim is to digitally reproduce
                all of the myriad complex relationships that made up the mythic
                storyworld in ancient texts. This is a work-in-progress. The
                genealogical tool uses just a subset of the available data:
                entities and ties collected from Apollodoros’ Library (link:
                <a
              ...
              >
                ...
                books. The dataset consists of all mythic characters who appear
                in the work and captures all explicit connections of blood or
              ...
              >
                ...
                ground. These stories often strengthen a community’s claim to
                long and uncontested ownership of a territory.{" "}
              ...
              >
                ...
                Gods – and some notable heroes – are said to have created
                mortals.{" "}
                <span style={{ fontStyle: "italic", color: "#808080" }}>
              ...
              >
                ...
                Some gods and heroes were said to have been born in strange
                ways, including from eggs, and from a body part of one of their
                parents.{" "}
                <span style={{ fontStyle: "italic", color: "#808080" }}>
